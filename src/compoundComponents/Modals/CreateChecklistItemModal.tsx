...
export const CreateChecklistItemModal: React.FC<CreateChecklistItemModalProps> = ({
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            setSubmitError(error instanceof Error ? error.message : i18n._('create-checklist.error.create', { default: 'Failed to create item' }));
        } finally {
        ...
        >
            ...
            <DialogContent>
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, pt: 1 }}>
                    ...
                    <TextField
                        label={
                            <Trans id="create-checklist.title-field" message="Title *" />
                        }
                        placeholder={i18n._('create-checklist.title-placeholder', { default: 'Enter a clear, descriptive title for your task' })}
                        ...
                        helperText={
                            !formData.title.trim() && formData.title !== ''
                                ...
                                : i18n._('create-checklist.title-helper', { default: 'Give your checklist item a clear, concise name' })
                        }
                    ...
                    <TextField
                        label={
                            <Trans id="create-checklist.description-field" message='Description *' />
                        }
                        placeholder={i18n._('create-checklist.description-placeholder', { default: 'Describe what needs to be done, any important details, or steps involved' })}
                        ...
                        helperText={
                            !formData.description.trim() && formData.description !== ''
                                ? i18n._('create-checklist.description-required', { default: 'Description is required' })
                                : i18n._('create-checklist.description-helper', { default: 'Provide details about this task - what needs to be accomplished?' })
                        }
                        disabled={isSubmitting}
                    />
                    ...
                    <FormControl fullWidth disabled={isSubmitting}>
                        ...
                        <Typography variant="caption" color="text.secondary" sx={{ mt: 0.5, ml: 1 }}>
                            <Trans id="create-checklist.importance-helper" message="How important is this task?" />
                        </Typography>
                    </FormControl>
                    ...
                    <FormControlLabel
                        ...
                        label={
                            <Box>
                                ...
                                <Typography variant="caption" color="text.secondary">
                                    <Trans id="create-checklist.mark-completed-helper" message="Check this if the task is already finished" />
                                </Typography>
                            </Box>
                        }
                    />
