...
const mockCreateChecklistItem = checklistApi.createChecklistItem as jest.MockedFunction<typeof checklistApi.createChecklistItem>;
...
describe('CreateChecklistItemButton', () => {
    ...
    it('handles form submission error', async () => {
        ...
        if (modalProps?.onSubmit) {
            ...
            await expect(modalProps.onSubmit({
                ownerId: 'user-123',
                title: 'Test Item',
                description: 'Test Description',
                isComplete: false,
